...
<%
/*
    Joshua Martin CSD430 Lab 7 Project Part 2 - movieCreate.jsp - 02/15/2026
    Instructor: David Ostrowski

    What this page does:
    Shows a form that collects movie info from the user,
    sends that input to the MovieBean,
    and uses the MovieBean to insert (CREATE) a new record into the josh_movies_data table.
    The movie_id key is auto-generated by MySQL when the record is inserted.
*/
%>
